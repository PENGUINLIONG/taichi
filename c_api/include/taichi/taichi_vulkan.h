...
// structure.vulkan_queue_interop_info
typedef struct TiVulkanQueueInteropInfo {
  VkQueue queue;
  uint32_t queue_family_index;
} TiVulkanQueueInteropInfo;
...
// function.import_vulkan_queue
TI_DLL_EXPORT TiQueue TI_API_CALL ti_import_vulkan_queue(
  const TiVulkanQueueInteropInfo* interop_info
);

// function.export_vulkan_queue
TI_DLL_EXPORT void TI_API_CALL ti_export_vulkan_queue(
  TiQueue queue,
   TiVulkanQueueInteropInfo* interop_info
);

// function.get_vulkan_queue_command_buffer
TI_DLL_EXPORT VkCommandBuffer TI_API_CALL ti_get_vulkan_queue_command_buffer(
  TiQueue queue
);
...
TI_DLL_EXPORT TiTexture TI_API_CALL ti_import_vulkan_texture(
  TiRuntime runtime,
...
TI_DLL_EXPORT void TI_API_CALL ti_export_vulkan_texture(
  TiRuntime runtime,
  TiTexture texture,
