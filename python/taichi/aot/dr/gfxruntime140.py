...
from taichi.aot.utils import json_data_model, dump_json_data_model
...
class TaskAttributes:
    def __init__(self, j: dict[str, Any]) -> None:
        ...
        self.range_for_attribs: Optional[RangeForAttributes] = RangeForAttributes(range_for_attribs) if range_for_attribs is not None else None
